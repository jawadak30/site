            ...
            <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                <div class="rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{ asset('storage/backend/' . $latest_post->cover) }}"
                            alt="">
                    ...
                    <div class="bg-light p-4">
                        <p class="text-primary fw-medium mb-2">{{ $latest_post->kategori->kategori }}</p>
                        <h5 class="lh-base mb-0">{{ $latest_post->judul }}</a>
                    </div>
                </div>
            </div>
